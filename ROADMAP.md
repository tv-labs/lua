...
### Known integer-semantics gap

- **A-int-overflow**: 64-bit integer wrapping for arithmetic and bitwise ops
  (cherry-picked from a prior local branch; matches Lua 5.3 spec semver).
