defmodule Lua.AST.MetaTest do
  ...
  describe "merge/2" do
    test "merges two metas taking earliest start" do
      meta1 = Meta.new(%{line: 1, column: 5, byte_offset: 10}, %{line: 1, column: 10, byte_offset: 20})
      meta2 = Meta.new(%{line: 1, column: 1, byte_offset: 5}, %{line: 1, column: 8, byte_offset: 15})
    ...
    test "merges two metas taking latest end" do
      meta1 = Meta.new(%{line: 1, column: 1, byte_offset: 0}, %{line: 1, column: 10, byte_offset: 9})
      meta2 = Meta.new(%{line: 1, column: 5, byte_offset: 4}, %{line: 1, column: 20, byte_offset: 19})
  ...
  describe "position tracking" do
    test "stores line numbers" do
      meta = Meta.new(%{line: 5, column: 10, byte_offset: 50}, %{line: 5, column: 20, byte_offset: 60})
    ...
    test "stores column numbers" do
      meta = Meta.new(%{line: 1, column: 5, byte_offset: 4}, %{line: 1, column: 15, byte_offset: 14})
    ...
    test "stores byte offsets" do
      meta = Meta.new(%{line: 1, column: 1, byte_offset: 100}, %{line: 1, column: 10, byte_offset: 200})
    ...
    test "handles multiline spans" do
      meta = Meta.new(%{line: 1, column: 1, byte_offset: 0}, %{line: 10, column: 5, byte_offset: 150})
